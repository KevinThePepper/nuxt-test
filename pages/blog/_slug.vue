  ...
  <div class>
    <div class="container lg:max-w-4xl mx-auto p-4 pb-8">
      <NuxtLink
        ...
        class="inline-flex items-center dark:hover:text-engins-bubblyblue light:hover:text-engins-bubblyblue dark:text-dark-onSurfaceSecondary light:text-light-onSurfaceSecondary"
      >
