        ...
        >
          ...
          >
            ...
            <div class="w-full px-6 py-2">
              ...
              <!-- <button class="snipcart-add-item inline-block bg-engins-bubblyblue text-white font-medium text-sm px-4 py-2 shadow uppercase rounded hover:bg-engins-kewlblue hover:shadow-md sm:mr-4 p-3 mt-3 text-sm text-left" :data-item-id="i + 1" :data-item-name="product.name" :data-item-description="product.description" :data-item-image="'/shop/' + product.img + '.png'" :data-item-price="product.price" :data-item-url="{ name: 'shop' }">
              </button> -->
            </div>
          </div>
        </div>
