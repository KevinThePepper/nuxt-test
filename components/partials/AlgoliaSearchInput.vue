<template>
  ...
  >
    ...
    <button
      ...
      class="absolute right-0 top-0 block outline-none flex h-full px-4 items-center justify-center text-engins-newnavy dark:text-dark-onSurfaceSecondary hover:text-engins-bubblyblue dark:hover:text-engins-bubblyblue z-10"
...
.light-mode .algolia-wrapper {
  .nui-search-input {
    ...
    color: theme('colors.engins.newnavy') !important;
  }
