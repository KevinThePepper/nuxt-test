<template>
  ...
  >
    <div class="w-full lg:w-2/3 flex flex-col justify-between pr-4">
      <div class="mb-2">
        <h2
          class="mb-4 inline-block leading-tight light:hover:text-engins-bubblyblue dark:hover:text-engins-bubblyblue light:text-light-onSurfacePrimary dark:text-dark-onSurfacePrimary font-semibold text-2xl md:text-3xl transition-colors duration-300 ease-linear"
        >
          {{ post.title }}
        </h2>
        <div class="mb-4">
      ...
      <div class="flex flex-col lg:flex-row text-sm">
        <div class="mb-4 lg:mb-0 flex items-center">
          ...
          >
            ...
            />
            <span
              class="leading-none last:mr-0 light:text-light-onSurfacePrimary dark:text-dark-onSurfacePrimary hover:text-engins-bubblyblue transition-colors duration-300 ease-linear"
            >
              {{ author.name }}
            </span>
          </span>
