<template>
  ...
  >
    ...
    >
      <!-- Logo -->
      <NuxtLink
        class="inline-block text-engins-newnavy h-7 lg:h-10 z-10 mr-auto"
        to="/"
        ...
        <ul class="flex text-center">
          ...
          >
            <NuxtLink
              ...
              class="block font-medium uppercase hover:no-underline light:hover:text-engins-bubblyblue dark:hover:text-engins-bubblyblue text-light-onSurfacePrimary dark:text-dark-onSurfacePrimary transition-colors duration-300 ease-linear"
              :to="
                localePath({
                  name: link.routeName,
                  params: {
            ...
            >
              {{ link.name }}
              <span
                class="bg-blue-200 dark:text-black text-ss align-top px-1 rounded-sm lowercase"
              >
                beta
              </span>
            </NuxtLink>
            ...
            <a
              ...
              :key="link.href"
              :href="link.href"
              class="block font-medium uppercase hover:no-underline hover:text-engins-bubblyblue text-light-onSurfacePrimary dark:text-dark-onSurfacePrimary transition-colors duration-300 ease-linear"
            >
              {{ link.name }}
            </a>
          </li>
